...
simple_agent = Agent(
    ...
    memory=memory,
    enable_user_memories=True,
    storage=PostgresStorage(table_name="simple_agent", db_url=db_url, auto_upgrade_schema=True),
)
...
research_agent = Agent(
    ...
    memory=memory,
    enable_user_memories=True,
    storage=PostgresStorage(table_name="research_agent", db_url=db_url, auto_upgrade_schema=True),
)
