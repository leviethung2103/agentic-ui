        ...
        <div className="relative">
            ...
            <Button
                ...
                className={cn(
                    ...
                    isDropdownOpen ? "bg-primary/10 text-primary" : "hover:bg-primary/5 text-muted hover:text-primary",
                )}
            ...
            >
                <div className="flex w-full items-center gap-3">
                    ...
                    <div className="flex min-w-0 flex-1 flex-col items-start">
                        ...
                        <p className="truncate text-xs opacity-70">{user.email || "user@example.com"}</p>
                    </div>
