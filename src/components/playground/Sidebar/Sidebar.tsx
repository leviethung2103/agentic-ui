...
const SidebarHeader = () => (
  <div className="flex items-center gap-2">
    ...
    <span className="text-xs font-medium uppercase text-white">KMSLV Agents</span>
  </div>
)
...
const Endpoint = () => {
  const { selectedEndpoint, isEndpointActive, setSelectedEndpoint, setAgents, setSessionsData, setMessages } =
    usePlaygroundStore()
  ...
  return (
    ...
    >
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
      >
        <Icon type="sheet" size="xs" className={`transform ${isCollapsed ? "rotate-180" : "rotate-0"}`} />
      </motion.button>
      <motion.div
